#sample program to decrypt a text file.
from tkinter import *
...
class code:
    ...
    def fun1(self):
         ...
         key=fil.read()
         fil.close()
         #Get the encrypted text from the file
         ...
         f1=open(code.file[0:len(code.file)-4]+'_Decrypted.txt','w')
         f1.write(final)
         f1.close()
         # Change label contents
         label_file_explorer.configure(text="Your file has been successfully Decrypted.Click on 'Browse File' below to Decrypt another file,\nelse close the application.")
